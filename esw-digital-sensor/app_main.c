...
static void mma_data_ready_loop (void *args)
{
    ...
    configure_interrupt(MMA8653FC_CTRL_REG3_POLARITY_LOW, MMA8653FC_CTRL_REG3_PINMODE_PP, MMA8653FC_CTRL_REG4_DRDY_INT_EN, MMA8653FC_CTRL_REG5_DRDY_INTSEL_INT1);
